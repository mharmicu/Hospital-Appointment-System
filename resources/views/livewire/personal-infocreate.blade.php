            ...
            <form>
                <div class="bg-blue-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="block text-green-500 text-sm font-bold mb-2">Sex</label>
                            <select class="appearance-none border-green-200 rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" wire:model="sex">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="block text-green-500 text-sm font-bold mb-2">Age</label>
                            <input type="text" autocomplete="off" class="appearance-none border-green-200 rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Input age" wire:model="age">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" autocomplete="off" class="appearance-none border-green-200 rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Input address" wire:model="address">
                            @error('address') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="block text-green-500 text-sm font-bold mb-2">Contact Number</label>
                            <input type="text" autocomplete="off" class="appearance-none border-green-200 rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Input contact number" wire:model="contactnum">
                            @error('contactnum') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
