...
<div class="bg-blue-200 py-12">
    <div class="bg-blue-200 max-w-9xl mx-auto sm:px-6 lg:px-10">
        <div class="bg-blue-100 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button onclick="confirm('Are you sure you want to add hospital?') || event.stopImmediatePropagation()" wire:click="hospitalcreate()" class="bg-blue-900 hover:bg-blue-500 text-white py-2 px-4 rounded my-3 fa fa-plus"> Create Hospital Information</button>
            ...
            @if($isOpen)
            @include('livewire.adminpagecreate')
            @endif
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static"><span class="lg:hidden absolute top-0 left-0 bg-blue-900 text-white px-2 py-1 text-xs font-bold uppercase">Action</span>
                                <button onclick="confirm('Are you sure you want to edit this data?') || event.stopImmediatePropagation()" wire:click="edit({{ $hospital->id }})" class="bg-blue-900 hover:bg-blue-500 text-white py-2 px-4 rounded fa fa-pencil-square-o"> Edit</button>
                                <button onclick="confirm('Are you sure you want to delete this data?') || event.stopImmediatePropagation()" wire:click="delete({{ $hospital->id }})" class="bg-red-700 hover:bg-red-500 text-white py-2 px-4 rounded fa fa-trash-o"> Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
