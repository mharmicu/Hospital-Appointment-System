        ...
        <div class="bg-blue-200 py-12">
            <div class="bg-blue-200 max-w-9xl mx-auto sm:px-6 lg:px-10">
                <div class="bg-blue-100 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    @if($isOpen)
                    @include('livewire.appointmentcreate')
                    @endif
                    <div class="table-responsive">
                        <table class="w-full border-collapse">
                            <thead>
                                <tr class="bg-blue-900">
                                    <th class="p-3 font-bold uppercase bg-blue-900 text-gray-200 border border-gray-300 hidden lg:table-cell">Appointment ID</th>
                                    ...
                                    <th class="p-3 font-bold uppercase bg-blue-900 text-gray-200 border border-gray-300 hidden lg:table-cell">Appointment Date</th>
                                    <th class="p-3 font-bold uppercase bg-blue-900 text-gray-200 border border-gray-300 hidden lg:table-cell">Appointment Time</th>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-red-100 lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                                    ...
                                    <td class="font-extrabold w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static"><span class="lg:hidden absolute top-0 left-0 bg-blue-900 text-white px-2 py-1 text-xs font-bold uppercase font-extrabold">Status</span>{{ $appointment->status }}</td>
                                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static"><span class="lg:hidden absolute top-0 left-0 bg-blue-900 text-white px-2 py-1 text-xs font-bold uppercase">Action</span>
                                        ...
                                        <button onclick="confirm('Are you sure you want to cancel this appointment?') || event.stopImmediatePropagation()" wire:click="delete({{ $appointment->id }})" class="bg-red-700 hover:bg-red-500 text-white py-2 px-4 rounded fa fa-ban"> Cancel Appointment</button>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
