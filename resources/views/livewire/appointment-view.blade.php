        ...
        <div class="bg-blue-200 py-12">
            <div class="bg-blue-200 max-w-9xl mx-auto sm:px-6 lg:px-10">
                <div class="bg-blue-100 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <a href="{{ route('pdf.generateUserAppointments') }}" class="float-right bg-blue-900 hover:bg-blue-500 text-white font-bold py-2 px-4 my-3 fa fa-download"> Download Appointments </a>
                        ...
                        <table class="w-full border-collapse">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-green-100 lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                                    ...
                                    <td class="font-extrabold w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static"><span class="lg:hidden absolute top-0 left-0 bg-blue-900 text-white px-2 py-1 text-xs font-bold uppercase ">Status</span>{{ $appointment->status }}</td>
                                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static"><span class="lg:hidden absolute top-0 left-0 bg-blue-900 text-white px-2 py-1 text-xs font-bold uppercase">Action</span>
                                        <button wire:click="view({{ $appointment->id }})" class="bg-blue-900 hover:bg-blue-500 text-white py-2 px-4 rounded fa fa-eye"> view </button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
